...
values  (1,'2023-02-16 16:35:15.338158', false, '2023-02-16 16:35:15.338158', 'whyWhale@ooo.co.kr', 'whyWhale1', '$2a$10$5.q.T.1X4UIHgrE2CGcNquu4K7lfX5ztWW8U6G59LJyGjd5BSgED2', 'USER', 'whyWhale1');
...
insert into product (id, created_at, deleted, updated_at, is_display, name, price, quantity, category_id, owner_id, product_thumbnail_id)
...
insert into order_product (id, created_at, deleted, updated_at, order_quantity, status, order_id, product_id, user_coupon_id)
